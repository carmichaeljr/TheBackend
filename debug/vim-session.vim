...
silent only
silent tabonly
cd ~/Documents/Programming/C++Programs/TheBackend/debug
...
wincmd w
argglobal
if bufexists('XMLTagDebug.cpp') | buffer XMLTagDebug.cpp | else | edit XMLTagDebug.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('TreeDebug.cpp') | buffer TreeDebug.cpp | else | edit TreeDebug.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('FileDebug.hpp') | buffer FileDebug.hpp | else | edit FileDebug.hpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 32 - ((30 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
...
wincmd w
argglobal
if bufexists('FileDebug.cpp') | buffer FileDebug.cpp | else | edit FileDebug.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('TokenizerDebug.cpp') | buffer TokenizerDebug.cpp | else | edit TokenizerDebug.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('HelperFuncDebug.cpp') | buffer HelperFuncDebug.cpp | else | edit HelperFuncDebug.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('Debug.cpp') | buffer Debug.cpp | else | edit Debug.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
